...
Multitool project is [Apache licensed](LICENSE.md) and accepts
...
- GitHub [issues](https://github.com/src-d/datasets/issues)*
...
Pull Requests (PRs) are the main and exclusive way to contribute to the official multitool project.
